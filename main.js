...
_.forEach(a => {
    glob.sync(`${appdata}\\${a}\\app-*\\modules\\discord_desktop_core-*\\discord_desktop_core`).map(async a => {
        ...
        if (fs.readFileSync(filename, 'utf-8').toString() !== "module.exports = require('./core.asar');") {
            console.info(`\x1b[31mYou have been token grabb in ${a.split('/')[5]} !\x1b[0m`)
            ...
            if (file.main && file.main !== "index.js") {
                console.info(`\x1b[31mYou have been token grab in ${file["main"]} !\x1b[0m`);
                ...
                console.log(`\x1b[32mL'instance ${a.split('/')[5]} is clean!\x1b[0m`)
            }
        } else {
